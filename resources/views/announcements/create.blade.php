    ...
    <div class="row my-5 mt-3">
      <div class="col-12 col-md-4 offset-md-4 col_form mb-5">
        <form method="POST" action="{{route('announcement.store')}}">
          ...
          <div class="mb-3">
            <label for="title" class="form-label text-main ">{{__('ui.title')}}</label>
          ...
          <div class="mb-3">
            <label for="category" class="form-label text-main">{{__('ui.category')}}</label>
            ...
            <div class="form-group row mb-3">
              <label for="images" class="col-12 col-form-label text-main">{{__('ui.uploadImages')}}</label>
              <div class="col-12">
            ...
            <div class="mb-3">
              <label for="price" class="form-label text-main">{{__('ui.price')}}   (€)</label>
            ...
            <div class="text-center">
              <button type="submit" class="btn btn-outline-main btn_sign_up mt-5 mx-auto">{{__('ui.submit')}}</button>
